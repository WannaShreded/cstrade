...
class HomeScreen extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // responsive tiles using Wrap so the whole page scrolls
                Padding(
  ...
  Widget _categoryTile(BuildContext context, String label) {
    ...
    final fallbackBase = baseName.endsWith('s')
        ...
        child: Card(
          ...
          child: Stack(
            ...
            children: [
              ...
              Container(
                decoration: BoxDecoration(gradient: _categoryGradient(label)),
              ),
              // Label text overlay
              Align(
  ...
  LinearGradient _categoryGradient(String label) {
    ...
    return LinearGradient(
      ...
      colors: [rarityColor.withOpacity(0.05), rarityColor.withOpacity(0.22)],
    );
  }
  ...
  Color _categoryRarityColor(String label) {
    ...
    if (l.contains('rifle') || l.contains('ak') || l.contains('m4'))
      return const Color(0xFF2979FF); // Blue
    if (l.contains('pistol') || l.contains('glock') || l.contains('usp'))
      return const Color(0xFF8E24AA); // Purple
    if (l.contains('smg') || l.contains('mac') || l.contains('ump'))
      return const Color(0xFF64B5F6); // Baby Blue
    if (l.contains('sniper') || l.contains('awp') || l.contains('scout'))
      return const Color(0xFFEC407A); // Pink
    if (l.contains('knife') || l.contains('melee'))
