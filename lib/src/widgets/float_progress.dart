...
class FloatProgress extends StatefulWidget {
  ...
  const FloatProgress({super.key, required this.value, this.height = 12.0, this.animationDuration = const Duration(milliseconds: 700)});

  @override
  State<FloatProgress> createState() => _FloatProgressState();
}

class _FloatProgressState extends State<FloatProgress> with SingleTickerProviderStateMixin {
                    ...
                    child: IgnorePointer(
                      child: Container(
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(height),
                          boxShadow: [
                            BoxShadow(color: Colors.green.withOpacity(0.06), blurRadius: 18, spreadRadius: 0.2),
                            BoxShadow(color: Colors.red.withOpacity(0.03), blurRadius: 10, spreadRadius: 0.2),
                          ],
                        ),
                      ),
                    ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w700, letterSpacing: 0.6),
                          ),
                        ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: RadialGradient(colors: [Colors.white.withOpacity(0.95), Colors.white.withOpacity(0.06)], radius: 0.6),
                            boxShadow: [
                              BoxShadow(color: Colors.black.withOpacity(0.6), blurRadius: 10, offset: const Offset(0, 6)),
                              BoxShadow(color: Colors.green.withOpacity(0.12), blurRadius: 18, spreadRadius: 1),
                            ],
